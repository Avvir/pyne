...
def some_second_file_test():
    from tests.test_helpers.test_modules import some_module_in_pyne_b
    ...
    def _(self):
        ...
        expect(loaded_modules_with_some).to_contain("tests.test_helpers.test_modules.some_module_in_pyne_b")
    ...
    def _(self):
        ...
        expect(loaded_modules_with_some).not_to_contain("tests.test_helpers.test_modules.some_module_in_pyne_a")
